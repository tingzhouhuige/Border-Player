...
mod io {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_border_player_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSMTCFlutter(
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_border_player_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSMTCFlutter(
        ptr: *const std::ffi::c_void,
    ) {
